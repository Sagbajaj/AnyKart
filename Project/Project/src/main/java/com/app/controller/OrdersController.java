...
import com.app.payment.OrderRequest;
import com.app.payment.OrderResponse;
import com.app.payment.PaymentResponse;
import com.app.payment.RazorPayClientConfig;
 
import com.app.pojos.User;
import com.app.service.OrderServicesImpl;
...
public class OrdersController {
	...
	private RazorPayClientConfig razorPayClientConfig;
	 ...
	 @Autowired
	    public void OrderController(RazorPayClientConfig razorpayClientConfig) throws RazorpayException {
	 ...
	 @PostMapping("/order")
	    public ResponseEntity<?> createOrder(@RequestBody OrderRequest orderRequest, User user) {
